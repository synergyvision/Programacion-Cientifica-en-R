...
```{r tut=TRUE, ex="mean", type="sct"}
test_function("mean")
test_object("mean_linkedin")
test_object("mean_facebook")
test_output_contains("mean(linkedin)", incorrect_msg = "Usar la función mean() y el vector linkedin")
test_output_contains("mean(facebook)", incorrect_msg = "Usar la función mean() y el vector facebook")
test_output_contains("mean_linkedin", incorrect_msg = " Recuerde guardar la media de linkedin en mean_linkedin")
test_output_contains("mean_facebook", incorrect_msg = " Recuerde guardar la media de facebook en mean_facebook")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="median", type="sct"}
test_function("median")
test_output_contains("median(linkedin)", incorrect_msg = "Usar la función median() y el vector linkedin")
test_output_contains("median(facebook)", incorrect_msg = "Usar la función median() y el vector facebook")
test_output_contains("median(x)", incorrect_msg = "Usar la función median() y el vector x")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="moda", type="sct"}
test_function("sort")
test_function("table")
test_output_contains("sort(x)", incorrect_msg = "Usar la función sort() y el vector x")
test_output_contains("sort(y)", incorrect_msg = "Usar la función sort() y el vector y")
test_output_contains("table(x)", incorrect_msg = "Usar la función table() y el vector x")
test_output_contains("table(y)", incorrect_msg = "Usar la función table() y el vector y")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="range", type="sct"}
test_function("range")
test_output_contains("range(linkedin)", incorrect_msg = "Usar la función range() y el vector linkedin")
test_output_contains("range(facebook)", incorrect_msg = "Usar la función range() y el vector facebook")
test_output_contains("range(x)", incorrect_msg = "Usar la función range() y el vector x")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="quantile", type="sct"}
test_function("quantile")
test_output_contains("quantile(linkedin)", incorrect_msg = "Usar la función quantile() y el vector linkedin")
test_output_contains("quantile(facebook)", incorrect_msg = "Usar la función quantile() y el vector facebook")
test_output_contains("quantile(x)", incorrect_msg = "Usar la función quantile() y el vector x")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="iqr", type="sct"}
test_function("IQR")
test_output_contains("IQR(linkedin)", incorrect_msg = "Usar la función IQR() y el vector linkedin")
test_output_contains("IQR(facebook)", incorrect_msg = "Usar la función IQR() y el vector facebook")
test_output_contains("IQR(x)", incorrect_msg = "Usar la función IQR() y el vector x")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="sd", type="sct"}
test_function("sd")
test_output_contains("sd(linkedin)", incorrect_msg = "Usar la función sd() y el vector linkedin")
test_output_contains("sd(facebook)", incorrect_msg = "Usar la función sd() y el vector facebook")
test_output_contains("sd(x)", incorrect_msg = "Usar la función sd() y el vector x")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="var", type="sct"}
test_function("var")
test_output_contains("var(linkedin)", incorrect_msg = "Usar la función var() y el vector linkedin")
test_output_contains("var(facebook)", incorrect_msg = "Usar la función var() y el vector facebook")
test_output_contains("var(x)", incorrect_msg = "Usar la función var() y el vector x")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="resumen", type="sct"}
test_function("summary")
test_output_contains("summary(x)", incorrect_msg = "Usar la función summary() y el vector x")
test_output_contains("summary(cars)", incorrect_msg = "Usar la función summary() y los datos de cars")
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="oper_arit", type="sct"}
test_error()
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="oper_com", type="sct"}
test_error()
success_msg("Excelente!")
```
...
```{r tut=TRUE, ex="oper_log", type="sct"}
test_error()
success_msg("Excelente!")
```
