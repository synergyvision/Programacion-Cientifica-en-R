...
```{r tut=TRUE, ex="seq", type="sct"}
test_output_contains("seq(from=1, to= 8, by=1.5)", incorrect_msg = "Recuerde usar seq()")
test_output_contains("seq(from=4, to= 5, by=0.01)", incorrect_msg = "Recuerde usar seq()")
test_output_contains("seq(from=20,length.out = 15)", incorrect_msg = "Recuerde usar seq()")
success_msg("Muy bien!")
```
...
```{r tut=TRUE, ex="rep", type="sct"}
test_output_contains("rep(x=2.15, times = 15)", incorrect_msg = "Recuerde usar rep()")
test_output_contains("rep(x='inicio', times = 3)", incorrect_msg = "Recuerde usar rep()")
test_output_contains("rep(x=1:3, times = 4)", incorrect_msg = "Recuerde usar rep()")
success_msg("Muy bien!")
```
...
```{r tut=TRUE, ex="seq1", type="sct"}
test_output_contains("sequence(nvec=15)", incorrect_msg = "Recuerde usar sequence()")
test_output_contains("sequence(nvec=c(3,7))", incorrect_msg = "Recuerde usar sequence()")
success_msg("Muy bien!")
```
...
```{r tut=TRUE, ex="gl", type="sct"}
test_output_contains("gl(n=4, k=3)", incorrect_msg = "Recuerde usar gl()")
test_output_contains("gl(n=2, k=5, label=c('casa', 'edificio'))", incorrect_msg = "Recuerde usar gl()")
success_msg("Muy bien!")
```
...
```{r tut=TRUE, ex="modf", type="sct"}
test_output_contains("x <- c(1:15,3,24,56,7,8.2)", incorrect_msg = "Recuerde usar c()")
test_output_contains("x[18]", incorrect_msg = "Recuerde usar []")
test_output_contains("x[-2]", incorrect_msg = "Recuerde usar [] y la posición en -")
test_output_contains("x[1:3]", incorrect_msg = "Recuerde usar : para la sucesión")
test_output_contains("x>4", incorrect_msg = "Recuerde usar >")
test_output_contains("x[1]<-15", incorrect_msg = "Recuerde usar [] y asignar <-")
success_msg("Muy bien!")
```
...
```{r tut=TRUE, ex="sumavec", type="sct"}
test_output_contains("x+y", incorrect_msg = "Recuerde usar +")
test_output_contains("x+y+z", incorrect_msg = "Recuerde usar +")
test_output_contains("sum(z)", incorrect_msg = "Recuerde usar sum()")
test_output_contains("x^2", incorrect_msg = "Recuerde usar ^")
success_msg("Muy bien!")
```
