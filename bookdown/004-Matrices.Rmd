...
```{r tut=TRUE, ex="matriz", type="sct"}
test_output_contains("M1", incorrect_msg = "Recuerde que la matriz se llama M1")
test_output_contains("M2", incorrect_msg = "Recuerde que la matriz se llama M1")
test_output_contains("M1[1,2]", incorrect_msg = "Recuerde que la posición se coloca entre []")
test_output_contains("M2[2,]", incorrect_msg = "Para la selección de filas es [fila,]")
test_output_contains("M1[,4]", incorrect_msg = "Para la selección de columnas es [, columna]")
test_output_contains("M1[2,3] <- 5", incorrect_msg = "Seleccionar elemento y luego asignar")
test_output_contains("M2+2 ", incorrect_msg = "Usar el operador +")
test_output_contains("cbind(M2,c(2,2,2,2,2))", incorrect_msg = "Usar la función cbind()")
test_output_contains("colSums(M1)", incorrect_msg = "Usar la función colSums()")
success_msg("Excelente!")
```
