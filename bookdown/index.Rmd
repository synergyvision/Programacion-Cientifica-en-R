...
```{r tut=TRUE,ex="create_a1", type="pre-exercise-code"}
b <- 5
```

```{r tut=TRUE,ex="create_a1", type="sample-code"}
...
```{r tut=TRUE,ex="create_a1", type="solution"}
# Crea una variable a, igual a 5
a <- 5
...
```{r tut=TRUE,ex="create_a1", type="sct"}
test_object("a")
